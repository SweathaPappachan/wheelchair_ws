...
(cl:defmethod cl:initialize-instance :after ((m <velocityEstimate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'velocityEstimate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<velocityEstimate> is deprecated: use xsens_msgs-msg:velocityEstimate instead.")))
...
(cl:defmethod velE-val ((m <velocityEstimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:velE-val is deprecated.  Use xsens_msgs-msg:velE instead.")
  (velE m))

(cl:ensure-generic-function 'velN-val :lambda-list '(m))
(cl:defmethod velN-val ((m <velocityEstimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:velN-val is deprecated.  Use xsens_msgs-msg:velN instead.")
  (velN m))

(cl:ensure-generic-function 'velU-val :lambda-list '(m))
(cl:defmethod velU-val ((m <velocityEstimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:velU-val is deprecated.  Use xsens_msgs-msg:velU instead.")
  (velU m))
