...
(cl:defmethod cl:initialize-instance :after ((m <positionEstimate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'positionEstimate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<positionEstimate> is deprecated: use xsens_msgs-msg:positionEstimate instead.")))
