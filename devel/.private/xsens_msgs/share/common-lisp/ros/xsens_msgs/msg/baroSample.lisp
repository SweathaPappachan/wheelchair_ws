...
(cl:defmethod cl:initialize-instance :after ((m <baroSample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'baroSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<baroSample> is deprecated: use xsens_msgs-msg:baroSample instead.")))
...
(cl:defmethod height-val ((m <baroSample>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:height-val is deprecated.  Use xsens_msgs-msg:height instead.")
  (height m))
