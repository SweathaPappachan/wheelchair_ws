...
struct TrajectoryScore_
{
  ...
  _traj_type traj;
   ...
   typedef std::vector< ::dwb_msgs::CriticScore_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dwb_msgs::CriticScore_<ContainerAllocator> >> _scores_type;
  _scores_type scores;
