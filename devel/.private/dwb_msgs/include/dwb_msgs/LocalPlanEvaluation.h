...
struct LocalPlanEvaluation_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::dwb_msgs::TrajectoryScore_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::dwb_msgs::TrajectoryScore_<ContainerAllocator> >> _twists_type;
  _twists_type twists;
